...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    return round(((budget/(exchange_rate*(1+spread/100)))//denomination)*denomination)
...
def unexchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    full_value=estimate_value(budget,exchange_rate*(1+spread/100))
    exchanged_value=exchangeable_value(budget,exchange_rate,spread,denomination)
    return int(full_value-exchanged_value)